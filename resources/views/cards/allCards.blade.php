...
<div class="container" dir="ltr">
    <form method="GET" action="{{ route('getcards') }}" class="mb-3 filter-form">
        <div class="d-flex flex-column">
            <div class="row mb-2 col-12" style="gap: 10px">
                ...
                <div>
                    ...
                    <select name="formula" id="formula" class="form-control">
                        <option value="">Select Formula</option>
                        <option value="numbers" {{ request()->formula == 'numbers' ? 'selected' : '' }}>Numbers</option>
                        <option value="letters" {{ request()->formula == 'letters' ? 'selected' : '' }}>Letters</option>
                        <option value="both" {{ request()->formula == 'both' ? 'selected' : '' }}>Both</option>
                    </select>
                </div>
            </div>
            <div class="row mb-2 col-12" style="gap: 10px">
                <div>
                    <label for="count_from" class="form-label">Count From</label>
                    <input type="number" name="count_from" id="count_from" value="{{ request()->count_from }}" class="form-control">
                </div>
                <div>
                    <label for="count_to" class="form-label">To</label>
            ...
            <div class="row mb-2 col-12" style="gap: 10px">
                ...
                <div>
                    <label for="price_to" class="form-label">To</label>
        ...
        <div class="col-3 mb-2 d-flex justify-content-between">
            ...
            <a href="{{ route('getcards') }}" class="btn btn-secondary">Clear Filters</a>
        </div>
    </form>
    ...
    <table class="table table-bordered mb-5">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('cards.pdf', $group->id) }}" class="btn btn-primary">Download PDF</a>
                </td>
            </tr>
            @empty
            <tr>
